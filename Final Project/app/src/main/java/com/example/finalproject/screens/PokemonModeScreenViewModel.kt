...
class PokemonModeScreenViewModel : ViewModel() {
    ...
    private fun generateNumbers() {
        val targetNumber = selectedNumber.value ?: 30
    ...
    private fun canConnectDirectly(board: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>): Boolean {
    ...
    private fun canConnectWithOneBend(board: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>): Boolean {
    ...
    private fun canConnectWithTwoBends(board: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>): Boolean {
    ...
    fun canConnect(board: Array<Array<Int>>, start: Pair<Int, Int>, end: Pair<Int, Int>): Boolean {
        if (canConnectDirectly(board, start, end)) return true
        if (canConnectWithOneBend(board, start, end)) return true
        if (canConnectWithTwoBends(board, start, end)) return true
        return false
    }
    fun validateSum() {
